...
('205180001', '205180000', 'mallProductManager', '商品管理', 'menu', '/mall/product-manager', 'iconfont icon-shangpin', 1, 1, 0, 1, '维护商品图片、规格、库存、限兑和履约方式', 0),
('205180002', '205180000', 'mallFulfillmentWorkbench', '兑换履约', 'menu', '/mall/fulfillment-workbench', 'iconfont icon-dingdan', 2, 1, 0, 1, '发货、到店领取、虚拟权益和取消退款工作台', 0),
