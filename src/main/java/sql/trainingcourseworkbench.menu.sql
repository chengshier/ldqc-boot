...
VALUES
('205170000', '0', 'trainingOperation', '培训运营', 'menu', '/training', 'iconfont icon-peixun', 17, 1, 0, 1, '课程资料、章节课时、审核和播放授权运营入口', 0),
('205170001', '205170000', 'trainingCourseManager', '课程管理', 'menu', '/training/courseManager', 'iconfont icon-kecheng', 1, 1, 0, 1, '维护课程基础资料和发布状态', 0),
('205170002', '205170000', 'trainingCourseWorkbench', '课程内容工作台', 'menu', '/training/courseWorkbench', 'iconfont icon-shipin', 2, 1, 0, 1, '维护章节、课时、试看、视频状态和用户授权', 0),
('205170003', '205170000', 'trainingCourseReview', '课程审核', 'menu', '/training/courseReview', 'iconfont icon-shenhe', 3, 1, 0, 1, '审核达人提交的课程、章节、课时和视频', 0),
...
('205170031', '205170003', 'trainingCourseReview_approve', '通过课程', 'approve', '/api/blade-training/course-review/approve', 'check', 1, 2, 2, 1, '通过审核并发布课程', 0),
('205170032', '205170003', 'trainingCourseReview_reject', '驳回课程', 'reject', '/api/blade-training/course-review/reject', 'close', 2, 2, 2, 1, '填写原因并驳回课程', 0)
