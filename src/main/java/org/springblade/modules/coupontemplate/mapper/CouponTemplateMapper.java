 ...
 */
package org.springblade.modules.coupontemplate.mapper;
...
public interface CouponTemplateMapper extends BaseMapper<CouponTemplateEntity> {
	 ...
	 * @return List<CouponTemplateVO>
	 */
	List<CouponTemplateVO> selectCouponTemplatePage(IPage page, CouponTemplateVO couponTemplate);
	 ...
	 */
	List<CouponTemplateExcel> exportCouponTemplate(@Param("ew") Wrapper<CouponTemplateEntity> queryWrapper);
