 ...
 */
package org.springblade.modules.pointsrule.service;
 ...
 * @since 2026-04-02
 */
public interface IPointsRuleService extends BaseService<PointsRuleEntity> {
	/**
	 * 自定义分页
	 *
	 * @param page 分页参数
	 * @param pointsRule 查询参数
	 * @return IPage<PointsRuleVO>
	 */
	IPage<PointsRuleVO> selectPointsRulePage(IPage<PointsRuleVO> page, PointsRuleVO pointsRule);
	 ...
	 * @return List<PointsRuleExcel>
	 */
	List<PointsRuleExcel> exportPointsRule(Wrapper<PointsRuleEntity> queryWrapper);
