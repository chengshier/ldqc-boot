 ...
 */
package org.springblade.modules.usercoupon.mapper;
...
public interface UserCouponMapper extends BaseMapper<UserCouponEntity> {
	 ...
	 */
	List<UserCouponVO> selectUserCouponPage(IPage page, UserCouponVO userCoupon);
	 ...
	 */
	List<UserCouponExcel> exportUserCoupon(@Param("ew") Wrapper<UserCouponEntity> queryWrapper);
