 ...
 */
package org.springblade.modules.usercoupon.wrapper;
 ...
 * @since 2026-04-02
 */
public class UserCouponWrapper extends BaseEntityWrapper<UserCouponEntity, UserCouponVO>  {
	...
	@Override
	public UserCouponVO entityVO(UserCouponEntity userCoupon) {
		UserCouponVO userCouponVO = Objects.requireNonNull(BeanUtil.copyProperties(userCoupon, UserCouponVO.class));
