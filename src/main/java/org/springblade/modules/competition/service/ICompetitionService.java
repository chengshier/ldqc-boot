 ...
 */
package org.springblade.modules.competition.service;
 ...
 * @since 2026-03-10
 */
public interface ICompetitionService extends BaseService<CompetitionEntity> {
	/**
	 * 自定义分页
	 *
	 * @param page 分页参数
	 * @param competition 查询参数
	 * @return IPage<CompetitionVO>
	 */
	 ...
	 * @return List<CompetitionExcel>
	 */
	List<CompetitionExcel> exportCompetition(Wrapper<CompetitionEntity> queryWrapper);
