 ...
 */
package org.springblade.modules.competition.mapper;
...
public interface CompetitionMapper extends BaseMapper<CompetitionEntity> {
	 ...
	 */
	List<CompetitionExcel> exportCompetition(@Param("ew") Wrapper<CompetitionEntity> queryWrapper);
