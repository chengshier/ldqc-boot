 ...
 */
package org.springblade.modules.pointsledger.mapper;
...
public interface PointsLedgerMapper extends BaseMapper<PointsLedgerEntity> {
	 ...
	 * @return List<PointsLedgerVO>
	 */
	List<PointsLedgerVO> selectPointsLedgerPage(IPage page, PointsLedgerVO pointsLedger);
	 ...
	 */
	List<PointsLedgerExcel> exportPointsLedger(@Param("ew") Wrapper<PointsLedgerEntity> queryWrapper);
