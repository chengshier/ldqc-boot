 ...
 */
package org.springblade.modules.album.wrapper;
 ...
 * @since 2026-01-27
 */
public class AlbumWrapper extends BaseEntityWrapper<AlbumEntity, AlbumVO>  {
	...
	@Override
	public AlbumVO entityVO(AlbumEntity album) {
		AlbumVO albumVO = Objects.requireNonNull(BeanUtil.copyProperties(album, AlbumVO.class));
