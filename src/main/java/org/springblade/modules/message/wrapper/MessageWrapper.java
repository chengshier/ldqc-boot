 ...
 */
package org.springblade.modules.message.wrapper;
 ...
 * @since 2026-01-27
 */
public class MessageWrapper extends BaseEntityWrapper<MessageEntity, MessageVO>  {
	...
	@Override
	public MessageVO entityVO(MessageEntity message) {
		MessageVO messageVO = Objects.requireNonNull(BeanUtil.copyProperties(message, MessageVO.class));
