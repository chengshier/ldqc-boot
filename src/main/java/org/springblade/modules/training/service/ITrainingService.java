 ...
 * @since 2026-03-10
 */
public interface ITrainingService extends BaseService<TrainingEntity> {
	/**
	 * 自定义分页
	 *
	 * @param page 分页参数
	 * @param training 查询参数
	 * @return IPage<TrainingVO>
	 */
	IPage<TrainingVO> selectTrainingPage(IPage<TrainingVO> page, TrainingVO training);
	 ...
	 */
	List<TrainingExcel> exportTraining(Wrapper<TrainingEntity> queryWrapper);
